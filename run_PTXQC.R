...
## your path
basedir = "c:/PTXQC/"  ## this is the path to the git repo. subdirectories are, e.g. ./R, or ./inst
setwd("c:\\")
...
for (s in all.sources) try ( source(s, keep.source = TRUE) )

yamlfile = "C:/PTXQC/report_v0.92.6.yaml"
yaml_obj = list()
